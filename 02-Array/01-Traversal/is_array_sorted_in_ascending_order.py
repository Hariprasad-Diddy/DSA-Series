def _is_array_sorted_in_ascending_order(number : list[int]) -> bool:
    """
...
if __name__ == "__main__":    
    print(_is_array_sorted_in_ascending_order([2,5,6,3,9,1,10]))
    print(_is_array_sorted_in_ascending_order([2,5,6]))
    print(_is_array_sorted_in_ascending_order([6,5,2]))
